...
public class QuerydslBasicTest {
    ...
    /**
     * 예) 회원과 팀을 조인하면서, 팀 일므이 teamA인 팀만 조인, 회원은 모두 조회
    ...
    public void bulkUpdate(){
        ...
        List<Member> result = queryFactory
                .selectFrom(member)
                .fetch();
        //영속성이 초기화가 되지 않았기 때문에 쿼리 돌기전의 데이터를 가지고 있다.
